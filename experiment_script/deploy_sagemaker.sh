...
case "$REGION" in
"us-west-2" )
    IMAGE="156387875391.dkr.ecr.us-west-2.amazonaws.com/forecasting-deepar:latest"
    ;;
"us-east-1" )
    IMAGE="522234722520.dkr.ecr.us-east-1.amazonaws.com/forecasting-deepar:latest" 
    ;;
"us-east-2" )
    IMAGE="566113047672.dkr.ecr.us-east-2.amazonaws.com/forecasting-deepar:latest" 
    ;;
"eu-west-1" )
    IMAGE="224300973850.dkr.ecr.eu-west-1.amazonaws.com/forecasting-deepar:latest" 
    ;;
 *)
